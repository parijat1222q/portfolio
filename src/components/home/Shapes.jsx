...
const Shapes = () => {
    ...
    return (
        <div className='shapes'>
            <motion.div animate={getParallaxStyle(0.02)} style={{ position: 'absolute', top: '15%', left: '10%' }}>
                <svg
                    width="27"
                    height="29"
                    className="shape s1"
            ...
            <motion.div animate={getParallaxStyle(0.04)} style={{ position: 'absolute', top: '20%', right: '15%' }}>
                <svg
                    width="26"
                    height="26"
                    className="shape s2"
            ...
            <motion.div animate={getParallaxStyle(0.03)} style={{ position: 'absolute', bottom: '15%', left: '25%' }}>
                <svg
                    width="30"
                    height="25"
                    className="shape s3"
            ...
            <motion.div animate={getParallaxStyle(0.05)} style={{ position: 'absolute', top: '40%', right: '10%' }}>
                <svg
                    width="15"
                    height="23"
                    className="shape s4"
            ...
            <motion.div animate={getParallaxStyle(0.02)} style={{ position: 'absolute', bottom: '20%', right: '25%' }}>
                <svg
                    width="15"
                    height="23"
                    className="shape s5"
            ...
            <motion.div animate={getParallaxStyle(0.06)} style={{ position: 'absolute', top: '10%', left: '40%' }}>
                <svg
                    width="49"
                    height="17"
                    className="shape s6"
            ...
            <motion.div animate={getParallaxStyle(0.03)} style={{ position: 'absolute', bottom: '10%', right: '5%' }}>
                <svg
                    width="26"
                    height="26"
                    className="shape s7"
            ...
            <motion.div animate={getParallaxStyle(0.04)} style={{ position: 'absolute', top: '70%', left: '5%' }}>
                <svg
                    width="19"
                    height="21"
                    className="shape s8"
            ...
            <motion.div animate={getParallaxStyle(0.02)} style={{ position: 'absolute', bottom: '40%', right: '35%' }}>
                <svg
                    width="30"
                    height="25"
                    className="shape s9"
                ...
                >
                    <path
                        d="M29.8564 16.0718c-2.85854 4.95114-8.1405 8.00057-13.85654 8.00024-5.71605-.00032-10.9981-3.04992-13.85641-8-2.8583-4.95007-2.8584-11.0491.00014-16.00024l2.77128 1.6c-2.28651 3.96036-2.28631 8.84002-.00011 12.8002 2.2862 3.96017 6.5124 6.40017 11.08513 6.4 4.57271-.00018 8.79872-2.43984 11.08524-6.4-4.57271.00018-8.79872 2.43984-11.08524-6.4002l2.77128 1.6z"
                        fill="#6C6CE5"
                        fillRule="evenodd"
                    />
                </svg>
            ...
            <motion.div animate={getParallaxStyle(0.05)} style={{ position: 'absolute', top: '50%', left: '50%' }}>
                <svg
                    width="47"
                    height="29"
                    className="shape s10"
            ...
            <motion.div animate={getParallaxStyle(0.02)} style={{ position: 'absolute', bottom: '5%', left: '45%' }}>
                <svg
                    width="33"
                    height="20"
                    className="shape s11"
